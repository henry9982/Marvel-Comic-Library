...
const CharacterCard = ({character}) => {
  ...
  return (
    <div key={character.id}  className='relative flex justify-center items-center w-fit  mx-auto card hover:scale-110 translate-x-7 max-md:translate-x-5  max-sm:translate-x-0 max-[320px]:hover:translate-x-6 '>
                      ...
                      <div className=' top-0 border-2 border-black border-l-0 flex justify-between flex-col  right-0 bg-[#333333]  w-3/6 h-[98%] max-[400px]:w-[51%] max-[400px]:pl-[2px] characterInfoBox  my-auto bottom-0  absolute'>
                        <div className='my-1 '>
                          ...
                          <div className='text-white -mt-1 font-poopins text-[13px] whitespace-nowrap overflow-auto characterInfoBoxName max-[470px]:text-[12px]'>{character.name}</div>
                          <div className='text-[12px] mt-1 tracking-wide character-des  overflow-auto  text-neutral-200 characterInfoBoxDes max-[470px]:text-[11px]'>{character.description?character.description:'No description about the character'}</div>
                        </div>
